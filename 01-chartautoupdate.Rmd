...
5. Finally, select the chart and right-click, click on "Select Data...", and then click on "Edit" for the series values. Add the named variable as the series value.
