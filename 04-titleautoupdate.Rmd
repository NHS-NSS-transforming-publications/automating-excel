...
In this worked example we are using [HSMR_TableA1b_Automated](https://github.com/NHS-NSS-transforming-publications/automating-excel/raw/master/HSMR_TableA1b_automated.xlsm), with sheets Table1 and Chart2. Each quarter a new row will be added, we need to make our title automically update to include this information.
